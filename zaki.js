        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            break
                    case 'bug': case 'report': {
                    	...
                    	zaki.sendMessage(`628889497632@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: `I Am RezzXD | © 2022`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'Github',
                                    url: 'https://github.com/itzrezz'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'Web Store',
                                    url: 'https://tukunang.my.id'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Menu',
...
//━━━━━━━━━━━━━━━[ MENU LOC ]━━━━━━━━━━━━━━━\\
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: anu.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `Jangan Spam Bot Jika Tidak Ingin Di Banned!`, hydratedButtons: [{ urlButton: { displayText: 'YouTube', url: 'GK PUNYA'} }, { urlButton: { displayText: 'Group', url: 'KOSONG'} }, { quickReplyButton: { displayText: 'Owner', id: 'owner', } }, { quickReplyButton: { displayText: 'Donate', id: 'donate', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
                        ...
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/rezasaha_'
                                }
                            }, {
                                callButton: {
...
case 'owner': case 'creator': {
    ...
    + 'FN:RezzXD\n'
    + 'ORG:I Am RezzXD;\n' //Nama Kalian
    + 'item1.TEL;type=CELL;type=VOICE;waid=6285878313791:+62 888-9497-632\n' //Nomor Kalian
    + 'item1.X-ABLabel:Creator Chitanda - MDt\n' //Info Kalian
    + 'item2.EMAIL;type=INTERNET:contact@rezakusuma.xyz\n' // Email Kalian
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/rezasaha_\n' //Ig Kalian Atau Web Kalian
    + 'item3.X-ABLabel:Instagram\n'
    + 'item4.ADR:;;Indonesia;;;;\n' //Negara Kalian
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
zaki.sendMessage(m.chat, { contacts: { displayName: 'I Am RezzXD', contacts: [{ vcard }] } }, { quoted: m })
            }
break 
